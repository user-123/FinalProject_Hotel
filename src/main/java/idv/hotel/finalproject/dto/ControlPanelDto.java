...
public class ControlPanelDto implements Serializable {
	...
	public String toString() {
		return "ControlPanelDto [totalOfRooms=" + totalOfRooms + ", totalOfBookedRooms=" + totalOfBookedRooms
				+ ", totalOfNotBookedRooms=" + totalOfNotBookedRooms + ", percentOfOccupancyRate="
				+ percentOfOccupancyRate + "]";
	}
