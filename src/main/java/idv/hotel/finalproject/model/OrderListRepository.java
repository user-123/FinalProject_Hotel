...
public interface OrderListRepository extends JpaRepository<OrderListBean, Integer> {
	...
	public List<OrderListBean> findDataByUserId(LoginBean userid);
	...
	@Modifying
	@Query(value = "delete from OrderListBean where orderid=?1",nativeQuery=true)
	public OrderListBean deleteDataByOrderId(String orderid);
