package idv.hotel.finalproject.payment.integration.ecpayOperator;
...
public class PaymentVerifyBase{
	protected String confPath = "/idv/hotel/finalproject/payment/integration/config/EcpayPayment.xml";
