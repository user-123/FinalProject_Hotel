...
>>>>>>> 3ed34646a540606683d940d7e6af26838735f2ed:src/main/webapp/WEB-INF/jsp/order/byuserid.jsp
...
<<<<<<< HEAD:src/main/webapp/WEB-INF/jsp/order/byUserid.jsp
														...
														value="刪除">
=======
														name="jsp" value="byUserid" />
														<input type="hidden" name="searchid" value="${datas.userid.accountId}" />
														<input type="hidden"
