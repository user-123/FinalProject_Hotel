							...
							<div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
								<ul class="navbar-nav">
									...
									<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
											...
											data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">會員</a>
										<c:choose>
										...
										<div class="title-single-box">
											...
											<div class="form-comments">
												<form:form method="POST" action="${contextRoot}/admin/room/add"
													modelAttribute="roomBean" enctype="multipart/form-data" id="room">
													<div class="row">
														...
														<div class="col-md-6 mb-3">
															<div class="form-group">
																...
																<form:textarea path="roomNameIntroduction"
																	id="roomNameIntroduction" class="input" rows="10"
														...
														<div class="col-md-6 mb-3">
															<div class="form-group">
																<form:label path="introduce">
																	簡介:</form:label>
																<br>
																<form:textarea path="introduce" id="introduce"
																	class="input" rows="10" cols="40" required="true" />
														...
														<div class="col-md-6 mb-3">
															<div class="form-group">
																<form:label path="equipment">
																	設備:</form:label>
																<br>
																<form:textarea path="equipment" id="equipment"
																	class="input" rows="10" cols="40" required="true" />
														...
														<div class="col-md-6 mb-3">
															<div class="form-group">
																<label for="room-photos">圖片:</label> <input type="file"
																	id="room-photos" class="input" name="files"
																	required="true" accept="image/*" multiple><br> <span
												...
												<div class="col-md-6 mb-3">
													<div class="form-group">
														<a class="btn btn-danger" href="${contextRoot}
