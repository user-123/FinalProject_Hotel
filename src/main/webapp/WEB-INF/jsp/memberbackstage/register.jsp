...
<body>
  ...
  <form:form id="registerForm" method="post" modelAttribute="loginBean"> 
    ...
    <button type="button" id="checksubmitadmin" class="btn btn-primary">新增會員</button>
    <button style="visibility:hidden" type="submit" id="submitadmin" class="btn btn-primary"></button>
