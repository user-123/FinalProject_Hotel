					...
					$(document)
						.ready(
							function () {
								...
								$('.row').each(function () {
									$(this).find(".ted").click(function () {
										var facility = $(this).closest('.property-grid').data('facility');

										var dialog = $("<div class='myLi'></div>").html(facility)
											.dialog({
												width: 1000,
												modal: true,
												autoOpen: false,
					...
					<div class="container">
						...
						<div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
							<ul class="navbar-nav">
								...
								<li class="nav-item"><a class="nav-link active" href="<c:url value='/public/facility/show'/>">休閒設施</a></li>
									...
									<c:choose>
										<c:when test="${sessionScope.login==true}">
											<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
												...
												<li><a class="dropdown-item " href="<c:url value='/logout'/>"> <input
						...
						<div class="container">
							<div class="row">
								<c:forEach items="${facility}" var="msg">
									<section class="property-grid gridgd" data-facility="<li>${msg.service}</li>">
										<div class="grbad">
											<div class="slideshow">
												<div class="slides">
