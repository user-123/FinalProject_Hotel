					...
					<div class="col-md-12 col-lg-8">
						<div class="title-single-box">
							...
							<div class="form-comments">
								...
								<img src="${contextRoot}/images/check.jpg" width="80"
									class='m-1 border rounded' />
								<h3>我們已收到您的訂單,歡迎再次光臨</h3>
								<a href="${contextRoot}/public/shop"><button
										class="btn btn-info" style="margin-left:700px">繼續逛商城</button></a>
							</div>
						</div>
					</div>
				</div>
