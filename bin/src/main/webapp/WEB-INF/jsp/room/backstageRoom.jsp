...
<body>
	...
	<h1>管理房型</h1>
	<div class="container">
		<form action="<c:url value="/roombean/backstageShowType" />"
			method="get">
			<select name="type">
	...
	<input type="button" value="新增" class="btn btn-primary"
		onclick="location.href='<c:url value='/roombean/create'/>'">
